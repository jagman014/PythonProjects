...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for data_dict in models.get('Contributor', []):
            ...
            if created:
                print(f'Created Contributor "{data_dict["contributor_first_names"]} {data_dict["contributor_last_names"]}"')
        ...
        for data_dict in models.get('BookContributor', []):
            ...
            if created:
                print(f'Created BookContributor "{contributor.email}" -> "{book.title}"')
